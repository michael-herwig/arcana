...
— 3057/4000 chars (counted) · wrapper: /goal — native in Claude Code, Codex CLI, Cursor CLI; drop the prefix elsewhere
...
```text
$ python3 -c 'import sys; print(len(open(sys.argv[1], encoding="utf-8").read()))' .tmp/dogfood-r3/ex5.txt
3057
```
